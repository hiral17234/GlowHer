...
export default function MentalHealthCheckInPage() {
    ...
    return (
        <div className="relative flex flex-col min-h-screen bg-gradient-to-br from-sky-200 to-purple-200 text-slate-800 selection:bg-purple-500/30">
            ...
            <main className="flex-grow flex items-center justify-center">
                <div className="text-center p-6 space-y-8">
                    ...
                    <div>
                        ...
                        <p className="text-lg md:text-xl text-slate-700 mb-8 max-w-xl mx-auto">
                            This is a safe space to clear your mind. Write whatever you feel, and watch it fade away. Your entry will be saved for private reflection.
                        </p>
                    </div>
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Button onClick={handleBegin} size="lg" className="px-10 py-8 text-xl font-bold bg-sky-500 hover:bg-sky-600 text-white shadow-lg">
                            Begin
                        </Button>
