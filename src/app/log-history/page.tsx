    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      <header className="container mx-auto px-4 py-6 z-10">
        <div className="flex justify-between items-center">
          <GlowHerLogo />
          <Button variant="ghost" onClick={() => router.push('/log-symptoms')}>
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-lg text-muted-foreground">Review your past entries and discover patterns in your wellness journey.</p>
          </div>
            ...
            <CardContent className="p-6">
              {loading ? (
                ...
                <div className="text-center py-12">
                    <p className="text-muted-foreground text-lg">You haven't logged any symptoms or moods yet.</p>
                    <Button className="mt-4" onClick={() => router.push('/log-symptoms')}>Start Logging</Button>
                </div>
              ) : (
