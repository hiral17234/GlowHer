...
const weeklyDevelopment = [
    ...
    },
    {
        ...
        summary: "Ovulation may happen about two weeks after your last period began. If egg meets sperm, you're on your way to being pregnant.",
        ...
        aiHint: "ovulation sperm"
    },
    {
        week: 3,
        title: "Week 3: Fertilization & Implantation",
        size: "The fertilized egg, or blastocyst, is a microscopic ball of cells.",
        summary: "Success! A sperm has fertilized the egg, and this new ball of cells, called a blastocyst, is making its way to your uterus for implantation.",
    ...
    },
    {
        ...
        summary: "An incredible milestone: your baby's heart begins to beat! The neural tube, which becomes the brain and spinal cord, is also forming now.",
    ...
    },
    {
        ...
        summary: "Basic facial features are taking shape. Dark spots mark where the eyes and nostrils will be, and tiny buds that will become arms and legs are sprouting.",
    ...
    },
    {
        ...
        summary: "Your baby's brain is developing at an astonishing rate, forming about 100 new cells every minute. Their arms and legs are getting longer.",
    ...
    },
    {
        ...
        summary: "This is a common week for your first prenatal appointment and ultrasound, where you may see your baby and their flickering heartbeat for the first time.",
    ...
    },
    {
        ...
        summary: "Big news! Your baby officially graduates from an embryo to a fetus. All their essential organs are formed and will now focus on growing and maturing.",
    ...
    },
    {
        ...
        summary: "Your fetus is looking more and more like a baby. Tiny fingernails are forming, and a fine, downy hair called lanugo is appearing on their skin.",
    ...
    },
    {
        ...
        summary: "The fetus is practicing reflexes, like opening and closing its fists and making sucking movements with its mouth. They're getting a workout in there!",
    ...
    },
    {
        ...
        summary: "Hello, second trimester! Often called the 'golden' trimester, you may feel your energy return. Your baby is busy developing vocal cords and unique fingerprints.",
    ...
    },
    {
        ...
        summary: "Your baby can now make facial expressions! They're also growing longer arms and a more distinct neck. Your energy levels are likely high.",
    ...
    },
    {
        ...
        summary: "Your baby's skeleton is hardening from cartilage to bone, and they can now sense light through their fused eyelids. They may even be able to hear you!",
    ...
    },
    {
        ...
        summary: "Get ready for a growth spurt! Your baby's nervous system is maturing, and you might start to feel the first gentle flutters of movement, called 'quickening.'",
    ...
    },
    {
        ...
        summary: "Your baby is starting to accumulate fat, which is crucial for staying warm after birth. Their hearing is improving, and they may be startled by loud noises.",
    ...
    },
    {
        ...
        summary: "Baby's hearing is now well-developed! They can hear your heartbeat, your voice, and other sounds from the outside world. Start talking and singing to them!",
    ...
    },
    {
        ...
        summary: "A greasy, cheese-like substance called vernix caseosa is now coating your baby's skin, protecting it from the amniotic fluid.",
    ...
    },
    {
        ...
        summary: "You're at the halfway point! This week is often when the detailed anatomy scan ultrasound is performed. Your baby is busy practicing swallowing.",
    ...
    },
    {
        ...
        summary: "Baby's taste buds are working! The flavors from the food you eat can pass into the amniotic fluid, giving your baby their first taste of what you're having for dinner.",
    ...
    },
    {
        ...
        summary: "With distinct lips, eyebrows, and eyelids, your baby now looks like a miniature newborn. Their pancreas is developing, which is key for producing hormones.",
    ...
    },
    {
        ...
        summary: "This is a major milestone: the age of viability. A baby born now has a chance of survival with intensive medical care as their lungs develop surfactant, a key substance for breathing.",
    ...
    },
    {
        ...
        summary: "Baby's brain is growing rapidly, and they can now feel movement and respond to your touch. Gently rubbing your belly is a new way to bond.",
    ...
    },
    {
        ...
        summary: "Peek-a-boo! Your baby's eyelids, which were fused shut, are now beginning to open. They can see light and dark and will blink in response.",
    ...
    },
    {
        ...
        summary: "You've reached the final trimester! Your baby's brain is very active, and you might start to feel their tiny hiccups as rhythmic, jerky movements.",
    ...
    },
    {
        ...
        summary: "Your baby can now blink and has a full set of eyelashes. They are also experiencing REM sleep, which means they are likely dreaming!",
    ...
    },
    {
        ...
        summary: "As space gets tighter, baby's movements might feel less like sharp kicks and more like strong rolls and stretches. Their adrenal glands are now producing hormones.",
    ...
    },
    {
        ...
        summary: "Your baby's eyesight is improving, and they can now see what's going on inside the uterus, like perceiving light filtering through your belly.",
    ...
    },
    {
        ...
        summary: "The baby is making rhythmic breathing movements, practicing for life on the outside. Their senses are all functional and they can regulate their own temperature.",
    ...
    },
    {
        ...
        summary: "Most babies flip into a head-down position this week in preparation for birth. Their soft skull plates are designed to overlap for an easier journey.",
    ...
    },
    {
        ...
        summary: "Baby's bones are hardening as they absorb lots of calcium from you. Their immune system is also getting a boost by borrowing your antibodies.",
    ...
    },
    {
        ...
        summary: "Baby's lungs are now well-developed and have a good chance of breathing without assistance if born now. Their fingernails have reached their fingertips.",
    ...
    },
    {
        ...
        summary: "Baby is packing on about half a pound per week now, plumping up for their arrival. Your prenatal appointments will likely become weekly.",
    ...
    },
    {
        ...
        summary: "At 'early term,' your baby is getting ready for their debut. They are likely settled head-down in your pelvis, which can relieve pressure on your ribs but increase it on your bladder.",
    ...
    },
    {
        ...
        summary: "Congratulations, you're full-term! Your baby's lungs and brain are fully mature. From here on out, it's just a waiting game for their grand arrival.",
    ...
    },
    {
        ...
        summary: "Baby has a firm grasp now and their eye color is likely blue or gray, though this may change after birth. You're in the waiting game now!",
    ...
    },
    {
        ...
        summary: "The final touches are being put on your baby's development. They are fully mature and just waiting for the right moment to arrive.",
    ...
    },
    {
        ...
        summary: "Happy due date! While only 5% of babies arrive on this exact day, know that your baby is fully cooked and ready to meet you whenever they decide it's time.",
