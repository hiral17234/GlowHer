...
import { ChevronLeft, Moon, Wind, Ear, Eye, Hand, Rss, Sparkles, Lightbulb, ArrowRight } from 'lucide-react';
...
export default function MoonAuraPage() {
    ...
    return (
        <div className="relative flex flex-col min-h-screen bg-cover bg-center text-white" style={{backgroundImage: "url('https://i.pinimg.com/736x/85/3a/2f/853a2f0348cd54053c52d69eca2e9626.jpg')"}}>
