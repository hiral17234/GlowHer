                ...
                <Card className="w-full max-w-4xl mx-auto shadow-lg">
                    <CardHeader>
                        <CardTitle className="font-headline text-2xl flex items-center gap-2"><Sparkles className="text-green-400" /> Reflect on Your Inner Nature</CardTitle>
                         <CardDescription>Answer these questions to connect with your personal growth.</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-8">
                         {!quizStarted ? (
                            ...
                            <div className="space-y-6">
                                ...
                                {advice && (
                                     <Alert className="mt-4 border-green-300 bg-green-50 dark:bg-green-900/20">
                                        <Lightbulb className="h-4 w-4 text-green-500" />
                                        <AlertTitle className="text-green-700 dark:text-green-300">Your Leaf Reflection</AlertTitle>
                                        <AlertDescription className="text-green-600 dark:text-green-200 whitespace-pre-wrap">
                                            {advice}
                                        </AlertDescription>
                                    </Alert>
                                )}
